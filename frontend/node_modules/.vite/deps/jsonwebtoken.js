...
var require_buffer_equal_constant_time = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var SlowBuffer = require_browser_external_buffer().SlowBuffer;
...
var require_verify = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var jws = require_jws();
	var { KeyObject, createSecretKey, createPublicKey } = require_browser_external_crypto();
	var PUB_KEY_ALGS = [
		"RS256",
		"RS384",
		"RS512"
	...
	module.exports = function(jwtString, secretOrPublicKey, options, callback) {
		...
		return getSecret(header, function(err, secretOrPublicKey) {
			...
			if (secretOrPublicKey != null && !(secretOrPublicKey instanceof KeyObject)) try {
...
var require_sign = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var { KeyObject, createSecretKey, createPrivateKey } = require_browser_external_crypto();
	var SUPPORTED_ALGS = [
		"RS256",
		"RS384",
		"RS512",
